...
public class ForcePikeModel extends net.minecraft.client.model.Model.Simple {
   ...
   public void render(com.mojang.blaze3d.vertex.PoseStack poseStack, com.mojang.blaze3d.vertex.VertexConsumer vertexConsumer, int i, int i1, float v, float v1, float v2, float v3) {
      this.root.render(poseStack, vertexConsumer, i, i1, ((int)(v3 * 255.0F) << 24) | ((int)(v * 255.0F) << 16) | ((int)(v1 * 255.0F) << 8) | (int)(v2 * 255.0F));
   }
}
