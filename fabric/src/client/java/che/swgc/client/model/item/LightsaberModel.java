...
public class LightsaberModel extends che.swgc.client.compat.model.SinglePartEntityModel<che.swgc.client.render.SwgcMobRenderState> {
   ...
   public static void regLayers(BiConsumer<net.minecraft.client.model.geom.ModelLayerLocation, Supplier<net.minecraft.client.model.geom.builders.LayerDefinition>> biConsumer) {
      BiConsumer<String, java.util.function.Supplier<net.minecraft.client.model.geom.builders.LayerDefinition>> register = (id, definition) -> biConsumer.accept(new net.minecraft.client.model.geom.ModelLayerLocation(Identifier.fromNamespaceAndPath("swgc", id), "lightsaber"), definition);
