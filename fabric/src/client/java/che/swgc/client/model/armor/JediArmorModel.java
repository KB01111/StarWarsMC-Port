...
public class JediArmorModel {
   ...
   public static net.minecraft.client.model.geom.builders.LayerDefinition createFemaleOuterLayer() {
      ...
      net.minecraft.client.model.geom.builders.PartDefinition head = partdefinition.addOrReplaceChild("head", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(0.0F, 24.0F, 0.0F));
