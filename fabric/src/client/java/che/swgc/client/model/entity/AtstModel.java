...
public class AtstModel<T extends Walker> extends che.swgc.client.compat.model.SinglePartEntityModel<T> implements RideableModel {
   ...
   public static net.minecraft.client.model.geom.builders.LayerDefinition createBodyLayer() {
      ...
      net.minecraft.client.model.geom.builders.PartDefinition root = partdefinition.addChild("root", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(-9.957F, -2.3087F, -1.3234F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition bone3 = bone.addChild("bone3", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(-0.3799F, 0.0409F, -21.4158F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition bone2 = bone.addChild("bone2", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(0.2152F, 0.0719F, -21.3961F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition hide_in_first_person = bone.addChild("hide_in_first_person", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(0.0F, 0.0F, 0.0F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition seat = bone.addChild("seat", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(0.2152F, -7.8658F, 3.1018F));
      net.minecraft.client.model.geom.builders.PartDefinition chair = body.addChild("chair", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(0.2002F, -28.6091F, 3.2644F));
      net.minecraft.client.model.geom.builders.PartDefinition left_leg = body.addChild("left_leg", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(8.3092F, 0.0434F, 0.0807F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition left_leg4 = left_leg.addChild("left_leg4", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(4.705F, 5.0612F, -16.9437F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition left_leg3 = left_leg2.addChild("left_leg3", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(-0.0349F, 38.995F, -0.145F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition right_leg = body.addChild("right_leg", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(-8.3088F, 0.0434F, 0.0807F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition right_leg4 = right_leg.addChild("right_leg4", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(-4.705F, 5.0612F, -16.9437F));
      ...
      net.minecraft.client.model.geom.builders.PartDefinition right_leg3 = right_leg2.addChild("right_leg3", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(0.0349F, 38.995F, -0.145F));
