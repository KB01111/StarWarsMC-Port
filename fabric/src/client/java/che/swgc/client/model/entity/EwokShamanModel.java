...
public class EwokShamanModel<T extends AbstractEwok> extends EwokModel<T> implements che.swgc.client.compat.model.ModelWithArms {
   ...
   public static net.minecraft.client.model.geom.builders.LayerDefinition createBodyLayer() {
      ...
      net.minecraft.client.model.geom.builders.PartDefinition item = left_arm2.addChild("item", net.minecraft.client.model.geom.builders.CubeListBuilder.create(), net.minecraft.client.model.geom.PartPose.offset(0.0F, 2.3F, 0.0F));
