...
public class DarkSaberItemRenderer extends LightsaberItemRenderer {
   private static final net.minecraft.resources.Identifier TEXTURE = Identifier.fromNamespaceAndPath("swgc", "textures/entity/item/lightsaber/dark.png");
   ...
   public void render(net.minecraft.world.item.ItemStack stack, net.minecraft.world.item.ItemDisplayContext ctx, com.mojang.blaze3d.vertex.PoseStack poseStack, che.swgc.client.compat.render.MultiBufferSource src, float partialTick, int packedLight, int packedOverlay) {
      ...
      this.model.render(poseStack, src.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entitySolid(TEXTURE)), packedLight, packedOverlay, 1.0F, 1.0F, 1.0F, 1.0F);
      if (ctx != net.minecraft.world.item.ItemDisplayContext.GUI && anim > 0.0F) {
         ...
         com.mojang.blaze3d.vertex.VertexConsumer buffer = src.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.debugQuads());
         Matrix4f pose = poseStack.last().pose();
         buffer.addVertex(pose, 0.0F, 0.0F, 0.0F).setColor(0, 0, 0, 255);
         buffer.addVertex(pose, 0.0F, 3.0F, 0.0F).setColor(0, 0, 0, 255);
         buffer.addVertex(pose, 0.0F, 2.25F, -0.1875F).setColor(0, 0, 0, 255);
         buffer.addVertex(pose, 0.0F, 0.0F, -0.1875F).setColor(0, 0, 0, 255);
         buffer.addVertex(pose, 0.0F, 0.0F, 0.0F).setColor(255, 255, 255, 255);
         buffer.addVertex(pose, 0.0F, 0.0F, 0.125F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, 3.0F, 0.125F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, 3.0F, 0.0F).setColor(255, 255, 255, 255);
         buffer.addVertex(pose, 0.0F, 3.0F, 0.0F).setColor(255, 255, 255, 255);
         buffer.addVertex(pose, 0.0F, 3.0F, 0.125F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, OUTLINE_Y0, 0.125F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, OUTLINE_Y0, 0.0F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, 3.0F, 0.0F).setColor(255, 255, 255, 255);
         buffer.addVertex(pose, 0.0F, OUTLINE_Y0, 0.0F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, OUTLINE_Y1, -0.3125F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, 2.25F, -0.1875F).setColor(255, 255, 255, 255);
         buffer.addVertex(pose, 0.0F, 2.25F, -0.1875F).setColor(255, 255, 255, 255);
         buffer.addVertex(pose, 0.0F, OUTLINE_Y1, -0.3125F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, 0.0F, -0.3125F).setColor(255, 255, 255, 0);
         buffer.addVertex(pose, 0.0F, 0.0F, -0.1875F).setColor(255, 255, 255, 255);
      }
