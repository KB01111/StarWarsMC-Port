...
public class AtrtRenderer extends che.swgc.client.render.SwgcMobRenderer<Walker, AtrtModel<Walker>> implements RideableRenderer<Walker> {
   ...
   public AtrtRenderer(net.minecraft.client.renderer.entity.EntityRendererProvider.Context ctx) {
      super(ctx, new AtrtModel(ctx.getPart(AtrtModel.LAYER_LOCATION)), 0.8F);
   }
